...
| Content Type | Conversion Goal | Metric |
|--------------|-----------------|--------|
| Blog posts | Email signup | Subscription rate |
| Case studies | Demo request | Form submissions |
| Product guides | Purchase | Sales attribution |
| Webinars | Lead qualification | Registration rate |
